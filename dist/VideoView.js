...
var useTakePicture_1 = require("./useTakePicture");
...
var VideoView = function (_a) {
    ...
    var _b = useTakePicture_1.useTakePicture(), captureImage = _b.captureImage, imageData = _b.imageData, switchCameraFacingMode = _b.switchCameraFacingMode; // customHook that contains logics
