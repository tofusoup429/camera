...
var MobileCameraFullScreenView2 = function (_a) {
    var bucketName = _a.bucketName, objectKey = _a.objectKey, imagesBase64Array = _a.imagesBase64Array, handleImagesBase64Array = _a.handleImagesBase64Array, view = _a.view, handleView = _a.handleView, uploadMergedImages = _a.uploadMergedImages, nameToMergedImages = _a.nameToMergedImages, handleNameToMergedImages = _a.handleNameToMergedImages;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, view === 'videoView' ?
        ...
        :
            react_1.default.createElement(ImageView_1.default, { objectKey: objectKey, imagesBase64Array: imagesBase64Array, width: width, uploadMergedImages: uploadMergedImages, nameToMergedImages: nameToMergedImages, handleNameToMergedImages: handleNameToMergedImages })));
};
