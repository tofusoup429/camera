...
var MobileCameraFullScreenView2 = function (_a) {
    var bucketName = _a.bucketName, objectKey = _a.objectKey, imageDatas = _a.imageDatas, handleImageDatas = _a.handleImageDatas, view = _a.view, handleView = _a.handleView, createPDFWithImages = _a.createPDFWithImages, pdfFileBase64 = _a.pdfFileBase64, handlePDFFileBase64 = _a.handlePDFFileBase64;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, view === 'videoView' ?
        ...
        :
            react_1.default.createElement(ImageView_1.default, { imageDatas: imageDatas, width: width, createPDFWithImages: createPDFWithImages, pdfFileBase64: pdfFileBase64, handlePDFFileBase64: handlePDFFileBase64 })));
};
