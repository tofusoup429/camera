...
var SmallImagesDisplayedOverlapped = function (_a) {
    var view = _a.view, handleView = _a.handleView, imageDatas = _a.imageDatas, imagesWidth = _a.imagesWidth, _b = _a.bottom, bottom = _b === void 0 ? 15 : _b, _c = _a.right, right = _c === void 0 ? 15 : _c;
    ...
    return (react_1.default.createElement("div", { id: "SmallImagesDisplayedOverlapped", style: { position: "absolute", bottom: bottom + "px", right: right + "px" } }, imageDatas.map(function (imageData, index) {
        return (imageData.length > 10 &&
            react_1.default.createElement("img", { key: index, src: imageData, width: imagesWidth, alt: 'NoImage', style: { position: "absolute", zIndex: 10 + index, bottom: bottom - index * 1 + "px", right: right - index * 1 + "px" } }));
    })));
};
